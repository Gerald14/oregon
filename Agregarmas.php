...
<header id="header">
<ul class="nav-top">
    <li><img src="imagenes/logo_oregon.png" alt="logo rocky" class="logo"></li>
...
<br/><br/>
        ...
        <h3>Nueva Venta</h3>
            ...
            <form class="form-horizontal" action="php/FinalizarVenta.php" method="post" class="form-register" onsubmit="return validar()" name="form5" enctype="multipart/form-data">
            ...
            <div class="col-lg-12" style="margin-top:2px;">
                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3""><label>Fecha: <input type="datatime" name="fecha" value="<?php echo            
                    $fecha_actual;?>" restricted></label></div>
                    <div class="col-xs-3 col-sm-3 col-md-3">
