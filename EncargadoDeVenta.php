...
<nav>
    <ul class="nav-lateral">
        ...
        <li style="margin-bottom: 25px" ><img src="imagenes/usuario.png" class="activo">
            <span style="color: aqua;text-align: center;margin-left: 75px;margin-bottom: 20px">Tecnico Maderero</span></li>
...
<div class="secciones">
    ...
    <article id="tab4">
        ...
        <p>Lista de los Ventas de la Empresa</p> 
            ...
            <form class="form-horizontal" action="ventana_busquedaventa.php" method="post" class="form-register" onsubmit="return validar()"  enctype="multipart/form-data">
            <div class="row">
                    <div class="col-md-4">
                ...
                <input type="submit" value="Buscar" class="btn__enviar">
            </div>
            </form>
            <table class="table">
                <thead>
    ...
    <div class="nav-form">
        ...
        <form class="form-horizontal" action="php/clientes.php" method="post" onsubmit="return validar()">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="edad_cliente">Edad:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="edad_cliente" placeholder="Ingrese su Edad..." name="edad_cliente" required>
                </div>
            </div>
    ...
    <article id="tab6">
        ...
        <form method='post' action ="./consultar_cliente_botica.php" enctype="multipart/form-data">
        <div class="form-group">
